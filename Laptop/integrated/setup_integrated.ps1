...
& $venvPython -m pip install --disable-pip-version-check --progress-bar off `
    ...
    "PyWavelets>=1.4" "scipy>=1.10" "pyserial>=3.5"
...
& $venvPython -c "import affectivecloud, bleak, cv2, enterble, mediapipe, mss, numpy, onnxruntime, scipy, serial, websockets; print('Integrated environment is ready.')"
